...
class CreateOrdersTable extends Migration
{
    ...
    public function up()
    {
        Schema::create('orders', function (Blueprint $table) {
            ...
            $table->tinyInteger('payment_type')->default(3);
            ...
            $table->string('tracking_post_code', 20)->nullable();
            ...
            $table->tinyInteger('order_status')->default(0)->comment('0 => processing, 1 => cending, 2 => returned, 3 => canceled');
            $table->timestamps();
            $table->softDeletes();
        });
    }
