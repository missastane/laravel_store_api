...
return [
    ...
    */
    ...
    "confirmed" => ":attribute با تکرار کلمه عبور مطابقت ندارد.",
    ...
    "required_with" => ":attribute الزامی است زمانی که فعال است.",
    "required_with_all" => ":attribute الزامی است زمانی که :values موجود است.",
    "required_without" => ":attribute الزامی است زمانی که :values موجود نیست.",
    "required_without_all" => ":attribute الزامی است زمانی که :values موجود نیست.",
    "same" => ":attribute و :other باید برابر هم باشند.",
    "size" => [
    ...
    'recaptcha' => ' :attribute ناموفق بود!',
    ...
    */
    'attributes' => [
        ...
        "original_name" => "نام اورجینال",
        "brand_id" => "نام برند",
        "category_id" => "نام دسته",
        "weight" => "وزن کالا",
        "height" => "ارتفاع کالا",
        "width" => "عرض کالا",
        "length" => "طول کالا",
        ...
        "g-recaptcha-response" => 'اعتبارسنجی کپچا',
